...
def image_create(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # Добавляем пользователя к создвнному объекту
...
def image_detail(request, id, slug):
    ...
    #Увеличиваем кол-во просмотров на картинки на 1
...
def image_list(request):
    ...
    try:
        ...
        if request.is_ajax():
            # если получили aja[ запрос с номером страницы, большим, чем их количество, возвращаем пустую страницу
            return HttpResponse('')
        # если номер страницы больше, чем их количество, возвращаем послденюю
